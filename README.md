...
A detailed list of all 151 (or 493, depending on scope) Pokémon in the Sinnoh Pokédex.

Data points including Pokémon identification number, name, types, abilities, and base stats.
